...
namespace VisualDebugger
{
	...
	void Camera::Zoom(PxReal amount, PxVec3 actorPosition, PxReal delta_time)
	{
		if (amount > 0)
	...
	void Camera::Move(PxReal delta_time, PxVec3 actorPosition, PxVec3 offset)
	{
		eye = (actorPosition + offset);
	}
}